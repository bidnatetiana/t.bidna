 ...
 * @param List listMethod 
 * 		IN: enthaelt alle Namen der Methoden, die @Test haben
 * @param List listIgnore enthaelt alle Namen der Methoden, die @Ignore haben
 * @param TestsClass tc Objekt der Klasse, die alle Test-Methoden hat
 * @param boolean btnOn steht fuer den Knopf btnStart und ist true wenn der Knopf gedrueckt wurde;  == false wenn der Knopf btnStop aktiev ist 
 * 
